...
use bevy::prelude::*;
use crate::{protocol::ProtocolIdAppExt, messages::outgoing::OutgoingMessageQueueInternal, prelude::ChannelConfiguration};
...
impl ChannelSetupAppExt for App {
    fn register_channel<C: Channel>(
        ...
        let store = OutgoingMessageQueueInternal::new();
